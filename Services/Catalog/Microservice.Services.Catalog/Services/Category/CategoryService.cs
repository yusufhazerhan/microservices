...
namespace Microservice.Services.Catalog.Services.Category
{
    public class CategoryService : ICategoryService
    {
        ...
        public async Task<Response<NoContent>> Update(CategoryDto request)
        {
            ...
            return result == null ? Response<NoContent>.Fail("Category not found.", HttpStatusCode.NotFound) : Response<NoContent>.Success(HttpStatusCode.NoContent);
        }
        public async Task<Response<NoContent>> Delete(string id)
        {
            ...
            return result.DeletedCount <= 0 ? Response<NoContent>.Fail("Category not found", HttpStatusCode.NotFound) : Response<NoContent>.Success(HttpStatusCode.NoContent);
        }
        public async Task<Response<CategoryDto>> Get(string id)
        {
            ...
            return category == null ? Response<CategoryDto>.Fail("Category not found.", HttpStatusCode.NotFound) :
